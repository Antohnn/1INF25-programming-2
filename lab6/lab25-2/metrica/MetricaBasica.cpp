...
ifstream& operator>>(ifstream &arch,MetricaBasica& metricaBasica) {
    return metricaBasica.leer(arch);
}
ofstream& operator<<(ofstream &archRep,MetricaBasica& metricaBasica) {
    return metricaBasica.imprimir(archRep);
}
