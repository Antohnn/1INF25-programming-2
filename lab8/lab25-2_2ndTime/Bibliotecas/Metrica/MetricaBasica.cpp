...
ofstream& MetricaBasica::imprimir(ofstream &archRep) {
    ...
    archRep<<this->get_horas_transmitidas()<<" "<<this->get_espectadores_promedio()<<endl;

    return archRep;
}
//
TipoMetrica MetricaBasica::get_tipo() const {
    return BASICA;
}
//
